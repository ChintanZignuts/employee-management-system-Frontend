...
const deleteItemConfirm = async () => {
  try {
    ...
    await axios.post(`/employee/delete/${deleteItemId.value}`, { forceDelete: permentDelete.value }, config)

    // Remove the deleted employee from the list
    employeeList.value = employeeList.value.filter(employee => employee.id !== deleteItemId.value)
          ...
          <div class="d-flex align-center">
            ...
            >
              <VImg
                ...
                src=""
              />
              <span v-else>{{ avatarText(item.raw.first_name+" "+item.raw.last_name) }}</span>
            </VAvatar>
